...
assert_contains "$alpha_output" $'MATCH\t103\t104\t1002\t'
assert_contains "$alpha_output" $'MATCH\t104\t200\t1002\t'
assert_contains "$alpha_output" $'MATCH\t105\t200\t1002\t'
...
assert_contains "$beta_output" $'MATCH\t107\t200\t1003\t'
assert_contains "$beta_output" $'MATCH\t108\t200\t1003\t'
