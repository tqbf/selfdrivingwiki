...
struct SourceDetailWebViewMenuTests {
    ...
    @Test func hitTestFlipsYAxis() {
        ...
        let r = SourceDetailWebView.cssHitTestPoint(
    ...
    @Test func hrefJSHitTestsAndEmbedsCoordinates() {
        let js = SourceDetailWebView.linkHrefAtJS(x: 12.5, y: 33)
    ...
    @Test func hrefJSKeepsOnlyHttpOrHttps() {
        let js = SourceDetailWebView.linkHrefAtJS(x: 1, y: 2)
    ...
    @Test func hrefJSUsesPOSIXDecimalPoint() {
        ...
        let js = SourceDetailWebView.linkHrefAtJS(x: 7.25, y: 0)
