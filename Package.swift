...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            // PODCAST_TRANSCRIPTS gates the Apple Podcasts transcript feature (off
            // for WIKIFS_APP_STORE=1 builds).
        ...
        .executableTarget(
            ...
            path: "Sources/WikiFS",
            // PODCAST_TRANSCRIPTS gates the podcast-aware Add-from-URL copy/routing.
            swiftSettings: podcastSwiftSettings,
        ...
        // Contents/Helpers and signs it beside wikictl.
        .executableTarget(
