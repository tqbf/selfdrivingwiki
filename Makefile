...
build: deps bun-check $(APP_ICON) prompts version
...
release: deps bun-check $(APP_ICON) prompts version
...
check-release: deps prompts version
	swift build -c release
	@echo "✓ compiles (release)"

# Run the test suite.
test: deps prompts version
	swift test
	@echo "✓ tests pass"
...
test-fast: deps prompts version
...
test-fast-release: deps prompts version
